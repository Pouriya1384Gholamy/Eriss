...
function HeroSection() {
  return (
    <section className='flex flex-col justify-center items-center sm:flex-row gap-4 mt-5 px-4'>
      ...
      <article
        className='relative flex flex-col justify-center items-center bg-cover bg-center bg-no-repeat rounded-2xl w-full sm:w-[366px] sm:h-[303px] md:w-[778px] md:h-[352px] min-h-[280px] p-6 md:p-8 overflow-hidden shadow-2xl shadow-[#9EAD8C]/20 transition-all duration-500 hover:shadow-[#9EAD8C]/30'
      ...
      >
        ...
        <div className="relative z-10 w-full flex flex-col items-center">
          {/* Premium Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-1.5 mb-1 rounded-full bg-[#9EAD8C]/10 backdrop-blur-sm border border-[#9EAD8C]/20 text-[#8A9A7B] text-[10px] md:text-xs font-medium self-end">
            <Leaf className="w-3.5 h-3.5" />
            <span>محصولات طبیعی</span>
          </div>

          <p className='font-bold text-2xl md:text-[28px] text-right leading-tight text-gray-800'>
            لورم ایپسوم متن ساختگی با تولید
            <span className='text-[#8A9A7B] block sm:inline'> سادگی نامفهوم از</span>
          </p>
          ...
          <button className='group relative overflow-hidden rounded-xl text-white text-[13px] w-[108px] h-[35px] mt-3
      ...
      <article className='flex flex-row gap-2 sm:gap-3 shrink-0'>
        <div className='flex flex-col gap-2 sm:gap-3'>
          ...
          <div className='relative w-[170px] h-[180px] sm:w-[120px] sm:h-[145px] md:w-[195px] md:h-[168px] rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-500 hover:-translate-y-1 group'>
            <img src={banner} alt="تصویر بنر" className='w-full h-full object-cover transition-transform duration-700 group-hover:scale-110' />
            ...
            <div className="absolute bottom-0 left-0 right-0 p-3 bg-gradient-to-t from-black/50 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-500 translate-y-2 group-hover:translate-y-0">
              <span className="text-white text-xs font-medium block text-center">بنر ویژه</span>
            </div>
          </div>
        </div>
        
        {/* Tall Box - Premium */}
        <div className='relative w-[190px] h-[375px] sm:w-[160px] sm:h-[303px] md:w-[210px] md:h-[352px] rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-500 hover:-translate-y-1 group' 
             style={{ background: 'linear-gradient(145deg, #9EAD8C, #8A9A7B)' }}>
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center gap-3 p-4">
            ...
            <div className="text-center">
              <h3 className="text-white font-bold text-base">محصولات</h3>
              <p className="text-white/70 text-xs">چوبی طبیعی</p>
            </div>
            <div className="w-10 h-0.5 rounded-full bg-white/40" />
            <p className="text-white/60 text-[10px] text-center">کیفیت عالی</p>
          </div>
