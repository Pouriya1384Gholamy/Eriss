...
function HeroSection() {
  ...
  return (
    <section className='flex flex-col justify-center items-center sm:flex-row gap-8 mt-4 px-4 z-0'>
      ...
      <article
        ...
        style={{backgroundImage: `linear-gradient(rgba(255,255,255,0.7), rgba(255,255,255,0.85)), url(${woodImage})`}} // ✅ استفاده از woodImage
      >
        ...
        <div className="relative z-10 w-full flex flex-col items-center">
          ...
          {/* ✅ دکمه مشاهده محصولات با useNavigate */}
          <button
            onClick={handleShopClick}
            className="group relative overflow-hidden rounded-xl text-white text-[13px] w-[148px] h-[35px] mt-3
      ...
      <article className='flex flex-row gap-2 sm:gap-3 shrink-0'>
        <div className='flex flex-col gap-2 sm:gap-3'>
          ...
          <div className='relative w-[170px] h-[180px] sm:w-[120px] sm:h-[145px] md:w-[195px] md:h-[168px] rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-500 hover:-translate-y-1 group'>
            <img src={bannerImage} alt="بنر اریس وود" className='w-full h-full object-cover transition-transform duration-700 group-hover:scale-110' /> {/* ✅ استفاده از bannerImage */}
        ...
        {/* ✅ استفاده از woodImage به عنوان بک‌گراند */}
        ...
        {/* ✅ اضافه کردن bannerImage1 به عنوان تگ img با افکت محو */}
        <img 
          src={bannerImage1} 
          alt="بنر ویژه" 
